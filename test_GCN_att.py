...
parser.add_argument('--model_name', type = str, default = 'GCN_EM_att', help = 'name of the model')
parser.add_argument('--save_name', type = str,default='checkpoint_GCN_EM_att')
...
model = {
	...
	'GCN': models.GCN,
    'GCN_EM_att': models.GCN_ATT
	# 'LSTM_SP': models.LSTM_SP
}

con = config.GraphATTConfig(args)
#con.load_train_data()
con.load_test_data()
# con.set_train_model()
