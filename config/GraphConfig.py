...
class GraphConfig(object):
    def __init__(self, args):
        ...
        self.test_epoch = 5
        self.pretrain_model = 'checkpoint/checkpoint_GCN_bert_att'
    ...
    def get_train_batch(self):
        ...
        for b in range(self.train_batches):
            ...
            for mapping in [node_mapping,edge_dis,head_index,tail_index,node_type]:
                mapping.zero_()
    ...
    def get_test_batch(self):
        ...
        for b in range(self.test_batches):
            ...
            for mapping in [relation_mask,node_mapping,edge_dis,head_index,tail_index,node_type,ht_pair_pos]:
                mapping.zero_()
        ...
        for epoch in range(self.max_epoch):
            ...
            for data in self.get_train_batch():
                ...
                predict_re = model(context_idxs, context_pos, context_ner, input_lengths,
                                   ...
                                   context_masks,context_starts, dis_h_2_t, dis_t_2_h)
